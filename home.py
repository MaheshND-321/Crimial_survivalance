...
pages = []
for i in range(5):
    pages.append(tk.Frame(root, bg="#9E9D9D"))
...
def basicPageSetup(pageNo):
    ...
    back_button = tk.Button(pages[pageNo], image=back_img, bg="#9E9D9D", bd=0, highlightthickness=0,
           activebackground="#9E9D9D", command=goBack)
    back_button.image = back_img
    back_button.place(x=10, y=10)

    heading = tk.Label(pages[pageNo], fg="white", bg="#9E9D9D", font="Arial 20 bold", pady=10)
    heading.pack()

    content = tk.Frame(pages[pageNo], bg="#9E9D9D", pady=20)
    content.pack(expand="true", fill="both")

    left_frame = tk.Frame(content, bg="#9E9D9D")
    left_frame.grid(row=0, column=0, sticky="nsew")

    right_frame = tk.LabelFrame(content, text="Detected Criminals", bg="#9E9D9D", font="Arial 20 bold", bd=4,
...
def getPage1():
    ...
    basicPageSetup(1)
    heading.configure(text="Register Criminal", bg="#9E9D9D")
    right_frame.configure(text="Enter Details", fg="white", bg="#9E9D9D")

    btn_grid = tk.Frame(left_frame, bg="#9E9D9D")
    btn_grid.pack()

    tk.Button(btn_grid, text="Select Images", command=lambda: selectMultiImage(opt_menu, menu_var), font="Arial 15 bold", bg="#000000",
           fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#9E9D9D",
    ...
    scrollbar = tk.Scrollbar(right_frame, command=canvas.yview, width=20, troughcolor="#9E9D9D", bd=0,
                          activebackground="#9E9D9D", bg="#000000", relief="raised")
    scrollbar.pack(side="left", fill="y")

    scroll_frame = tk.Frame(canvas, bg="#9E9D9D", pady=20)
    ...
    tk.Label(scroll_frame, text="* Required Fields", bg="#9E9D9D", fg="yellow", font="Arial 13 bold").pack()
    # Adding Input Fields
    ...
    for i, field in enumerate(input_fields):
        print()
        row = tk.Frame(scroll_frame, bg="#9E9D9D")
        row.pack(side="top", fill="x", pady=15)

        label = tk.Text(row, width=20, height=1, bg="#9E9D9D", fg="#ffffff", font="Arial 13", highlightthickness=0, bd=0)
        ...
        if(i != ip_len-1):
            ...
            opt_menu.configure(font="Arial 13", bg="#000000", fg="white", bd=0, highlightthickness=0, activebackground="#9E9D9D")
    ...
    tk.Button(scroll_frame, text="Register", command=lambda: register(entries, required, menu_var), font="Arial 15 bold",
           bg="#000000", fg="white", pady=10, padx=30, bd=0, highlightthickness=0, activebackground="#9E9D9D",
...
def getPage4(path):
    ...
    btn_grid = tk.Frame(right_frame, bg="#9E9D9D")
    btn_grid.pack()
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Criminal Surveillance System Using Face Recognition", fg="red", bg="#9E9D9D",
      font="Arial 25 bold", pady=30).pack()

logo = tk.PhotoImage(file = r"C:\Users\alexa\major_proj\Facial-Recognition-for-Crime-Detection\img\logo32.png")
tk.Label(pages[0], image=logo, bg="#9E9D9D").pack(side='left')

btn_frame = tk.Frame(pages[0], bg="#9E9D9D", pady=25)
btn_frame.pack()
...
for btn in btn_frame.winfo_children():
    btn.configure(font="Arial 20", width=17, bg="#000000", fg="white",
        pady=15, bd=0, highlightthickness=0, activebackground="#9E9D9D", activeforeground="white")
    btn.pack(pady=30)
